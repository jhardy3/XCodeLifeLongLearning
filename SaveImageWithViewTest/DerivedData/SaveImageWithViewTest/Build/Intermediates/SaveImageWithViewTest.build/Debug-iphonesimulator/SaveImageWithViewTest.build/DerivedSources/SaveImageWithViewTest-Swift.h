...
SWIFT_CLASS("_TtC21SaveImageWithViewTest11AppDelegate")
...
SWIFT_CLASS("_TtC21SaveImageWithViewTest13ImageUitilies")
...
@interface UIImageView (SWIFT_EXTENSION(SaveImageWithViewTest))
...
SWIFT_CLASS("_TtC21SaveImageWithViewTest14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified testLabel;
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified testImageView;
- (void)viewDidLoad;
- (void)didReceiveMemoryWarning;
- (IBAction)theTestTap:(UITapGestureRecognizer * _Nonnull)sender;
